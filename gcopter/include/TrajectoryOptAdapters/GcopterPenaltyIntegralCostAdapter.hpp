...
{
struct GcopterPenaltyIntegralCostAdapter
{
    using VectorType = Eigen::Vector3d;

    const traj_opt_components::PolyhedraH *h_polys = nullptr;
    ...
    void reset(const traj_opt_components::PolyhedraH *polys,
                      ...
                      VectorType & /*gs*/, double & /*gt*/) const
    {
        ...
        const traj_opt_components::PolyhedronH &poly = (*h_polys)[poly_id];
        double pena = 0.0;
